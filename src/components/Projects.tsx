                ...
                <div className="flex flex-1 flex-col p-6">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-accent-soft">
                    {hasImage ? (
                      ...
                      <project.icon className="text-xl text-accent" />
                    )}
                  </div>
                  <h3 className="font-display mb-3 text-lg font-medium text-white transition-colors group-hover:text-accent">
                    {project.title}
                  </h3>
                    ...
                    <div className="flex gap-3">
                      {project.links.live && (
                        <a
                          ...
                          className="btn-press inline-flex items-center gap-1.5 rounded-lg bg-accent px-4 py-2 text-xs font-semibold text-[#14120f] transition-colors hover:bg-[#dd934f]"
                        >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="gradient-border btn-press inline-flex items-center gap-1.5 rounded-lg px-4 py-2 text-xs font-semibold text-zinc-300 transition-colors hover:text-white"
                      >
